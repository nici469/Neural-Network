...
{
    /// <summary>
    /// for testing data classification wit RELU_RNN_NEW
    /// </summary>
    class SampleGeneratorClass
    {
        public SampleGeneratorClass()
        {
        ...
        /// <summary>
        ///  checks if the count condition of each output has been reached, and gives a value
